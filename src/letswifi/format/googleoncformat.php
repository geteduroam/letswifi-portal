...
class GoogleOncFormat extends Format
{
	...
	protected function generatePayload(): array
	{
		...
		$serverSubjectMatch = $this->getLongestSuffix( ...$this->credential->realm->serverNames );
	...
	/**
	 * @param array<X509> $certificates Authentication method
	 *
	 * @return array<array{GUID: string, Remove: false, Type: string, X509: string}> ONC Certificate payload
	 */
	protected static function getCAPayloadFromAuthMethod( array $certificates ): array
	{
